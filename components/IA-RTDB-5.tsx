...
const IARTDB5 = ({
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-5-topSwitchClosed");
    if (saved !== null) {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-5-isZoomed");
    if (saved !== null) {
  ...
  useEffect(() => {
    ...
    loadSwitchState("IA-RTDB-5-switch1Closed", setSwitch1Closed);
    loadSwitchState("IA-RTDB-5-switch2Closed", setSwitch2Closed);
    loadSwitchState("IA-RTDB-5-switch3Closed", setSwitch3Closed);
    loadSwitchState("IA-RTDB-5-switch4Closed", setSwitch4Closed);
    loadSwitchState("IA-RTDB-5-switch5Closed", setSwitch5Closed);
    loadSwitchState("IA-RTDB-5-switch6Closed", setSwitch6Closed);
    loadSwitchState("IA-RTDB-5-switch7Closed", setSwitch7Closed);
    loadSwitchState("IA-RTDB-5-switch8Closed", setSwitch8Closed);
    loadSwitchState("IA-RTDB-5-switch9Closed", setSwitch9Closed);
    loadSwitchState("IA-RTDB-5-switch10Closed", setSwitch10Closed);
    loadSwitchState("IA-RTDB-5-switch11Closed", setSwitch11Closed);
    loadSwitchState("IA-RTDB-5-switch12Closed", setSwitch12Closed);
    loadSwitchState("IA-RTDB-5-switch13Closed", setSwitch13Closed);
        ...
        (() => {
          ...
          return createPortal(
            ...
            >
              ...
              >
                {/* Title for the box - match IA-RTDB-5 styling */}
                <div
                  style={{
                    position: "absolute",
                    top: 0,
