...
interface FourIGBTCircuit2Props {
...
const FourIGBTCircuit2 = ({
  ...
  const STORAGE_KEYS = {
    ISOLATOR: "FourIGBT2.isCircuitOn",
    OUTPUTS: "FourIGBT2.outputSwitches",
  };
...
export default FourIGBTCircuit2;
