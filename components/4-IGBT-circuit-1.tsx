...
interface FourIGBTCircuit1Props {
...
const FourIGBTCircuit1 = ({
  ...
  const STORAGE_KEYS = {
    ISOLATOR: "FourIGBT1.isCircuitOn",
    OUTPUTS: "FourIGBT1.outputSwitches",
  };
...
export default FourIGBTCircuit1;
