...
const IARTDB8 = ({
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-8-topSwitchClosed");
    if (saved !== null) {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-8-isZoomed");
    if (saved !== null) {
  ...
  useEffect(() => {
    ...
    loadSwitchState("IA-RTDB-8-switch1Closed", setSwitch1Closed);
    loadSwitchState("IA-RTDB-8-switch2Closed", setSwitch2Closed);
    loadSwitchState("IA-RTDB-8-switch3Closed", setSwitch3Closed);
    loadSwitchState("IA-RTDB-8-switch4Closed", setSwitch4Closed);
    loadSwitchState("IA-RTDB-8-switch5Closed", setSwitch5Closed);
    loadSwitchState("IA-RTDB-8-switch6Closed", setSwitch6Closed);
    loadSwitchState("IA-RTDB-8-switch7Closed", setSwitch7Closed);
    loadSwitchState("IA-RTDB-8-switch8Closed", setSwitch8Closed);
    loadSwitchState("IA-RTDB-8-switch9Closed", setSwitch9Closed);
    loadSwitchState("IA-RTDB-8-switch10Closed", setSwitch10Closed);
    loadSwitchState("IA-RTDB-8-switch11Closed", setSwitch11Closed);
    loadSwitchState("IA-RTDB-8-switch12Closed", setSwitch12Closed);
        ...
        (() => {
          ...
          return createPortal(
            ...
            >
              ...
              >
                {/* Title for the box - match IA-RTDB-8 styling */}
                <div
                  style={{
                    position: "absolute",
                    top: 0,
