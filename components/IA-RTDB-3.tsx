...
const IARTDB3 = ({
  ...
  useEffect(() => {
    try {
      ...
      load("IA-RTDB-3-topSwitchClosed", setTopSwitchClosed);
      load("IA-RTDB-3-switch1Closed", setSwitch1Closed);
      load("IA-RTDB-3-switch2Closed", setSwitch2Closed);
      load("IA-RTDB-3-switch3Closed", setSwitch3Closed);
      load("IA-RTDB-3-switch4Closed", setSwitch4Closed);
      load("IA-RTDB-3-switch5Closed", setSwitch5Closed);
      load("IA-RTDB-3-switch6Closed", setSwitch6Closed);
      load("IA-RTDB-3-switch7Closed", setSwitch7Closed);
      load("IA-RTDB-3-switch8Closed", setSwitch8Closed);
      load("IA-RTDB-3-isZoomed", setIsZoomed);
    } catch (e) {
      // ignore
    }
  }, []);
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "IA-RTDB-3-topSwitchClosed",
        JSON.stringify(topSwitchClosed)
      );
      localStorage.setItem(
        "IA-RTDB-3-switch1Closed",
        JSON.stringify(switch1Closed)
      );
      localStorage.setItem(
        "IA-RTDB-3-switch2Closed",
        JSON.stringify(switch2Closed)
      );
      localStorage.setItem(
        "IA-RTDB-3-switch3Closed",
        JSON.stringify(switch3Closed)
      );
      localStorage.setItem(
        "IA-RTDB-3-switch4Closed",
        JSON.stringify(switch4Closed)
      );
      localStorage.setItem(
        "IA-RTDB-3-switch5Closed",
        JSON.stringify(switch5Closed)
      );
      localStorage.setItem(
        "IA-RTDB-3-switch6Closed",
        JSON.stringify(switch6Closed)
      );
      localStorage.setItem(
        "IA-RTDB-3-switch7Closed",
        JSON.stringify(switch7Closed)
      );
      localStorage.setItem(
        "IA-RTDB-3-switch8Closed",
        JSON.stringify(switch8Closed)
      );
      localStorage.setItem("IA-RTDB-3-isZoomed", JSON.stringify(isZoomed));
    } catch (e) {}
  }, [
    topSwitchClosed,
    switch1Closed,
