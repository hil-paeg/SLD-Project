...
const IBRTDB5 = ({
  ...
  useEffect(() => {
    try {
      ...
      load("IB-RTDB-5-topSwitchClosed", setTopSwitchClosed);
      load("IB-RTDB-5-switch1Closed", setSwitch1Closed);
      load("IB-RTDB-5-switch2Closed", setSwitch2Closed);
      load("IB-RTDB-5-switch3Closed", setSwitch3Closed);
      load("IB-RTDB-5-switch4Closed", setSwitch4Closed);
      load("IB-RTDB-5-switch5Closed", setSwitch5Closed);
      load("IB-RTDB-5-switch6Closed", setSwitch6Closed);
      load("IB-RTDB-5-switch7Closed", setSwitch7Closed);
      load("IB-RTDB-5-switch8Closed", setSwitch8Closed);
      load("IB-RTDB-5-isZoomed", setIsZoomed);
    } catch (e) {
      // ignore
    }
  }, []);
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "IB-RTDB-5-topSwitchClosed",
        JSON.stringify(topSwitchClosed)
      );
      localStorage.setItem(
        "IB-RTDB-5-switch1Closed",
        JSON.stringify(switch1Closed)
      );
      localStorage.setItem(
        "IB-RTDB-5-switch2Closed",
        JSON.stringify(switch2Closed)
      );
      localStorage.setItem(
        "IB-RTDB-5-switch3Closed",
        JSON.stringify(switch3Closed)
      );
      localStorage.setItem(
        "IB-RTDB-5-switch4Closed",
        JSON.stringify(switch4Closed)
      );
      localStorage.setItem(
        "IB-RTDB-5-switch5Closed",
        JSON.stringify(switch5Closed)
      );
      localStorage.setItem(
        "IB-RTDB-5-switch6Closed",
        JSON.stringify(switch6Closed)
      );
      localStorage.setItem(
        "IB-RTDB-5-switch7Closed",
        JSON.stringify(switch7Closed)
      );
      localStorage.setItem(
        "IB-RTDB-5-switch8Closed",
        JSON.stringify(switch8Closed)
      );
      localStorage.setItem("IB-RTDB-5-isZoomed", JSON.stringify(isZoomed));
    } catch (e) {}
  }, [
    topSwitchClosed,
    switch1Closed,
