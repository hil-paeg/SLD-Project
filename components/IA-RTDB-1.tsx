...
const IARTDB1 = ({
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-1-topSwitchClosed");
    if (saved !== null) {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-1-isZoomed");
    if (saved !== null) {
  ...
  useEffect(() => {
    ...
    loadSwitchState("IA-RTDB-1-switch1Closed", setSwitch1Closed);
    loadSwitchState("IA-RTDB-1-switch2Closed", setSwitch2Closed);
    loadSwitchState("IA-RTDB-1-switch3Closed", setSwitch3Closed);
    loadSwitchState("IA-RTDB-1-switch4Closed", setSwitch4Closed);
    loadSwitchState("IA-RTDB-1-switch5Closed", setSwitch5Closed);
    loadSwitchState("IA-RTDB-1-switch6Closed", setSwitch6Closed);
    loadSwitchState("IA-RTDB-1-switch7Closed", setSwitch7Closed);
    loadSwitchState("IA-RTDB-1-switch8Closed", setSwitch8Closed);
    loadSwitchState("IA-RTDB-1-switch9Closed", setSwitch9Closed);
    loadSwitchState("IA-RTDB-1-switch10Closed", setSwitch10Closed);
    loadSwitchState("IA-RTDB-1-switch11Closed", setSwitch11Closed);
    loadSwitchState("IA-RTDB-1-switch12Closed", setSwitch12Closed);
