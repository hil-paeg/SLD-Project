...
const IARTDB6 = ({
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-6-topSwitchClosed");
    if (saved !== null) {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-6-isZoomed");
    if (saved !== null) {
  ...
  useEffect(() => {
    ...
    loadSwitchState("IA-RTDB-6-switch1Closed", setSwitch1Closed);
    loadSwitchState("IA-RTDB-6-switch2Closed", setSwitch2Closed);
    loadSwitchState("IA-RTDB-6-switch3Closed", setSwitch3Closed);
    loadSwitchState("IA-RTDB-6-switch4Closed", setSwitch4Closed);
    loadSwitchState("IA-RTDB-6-switch5Closed", setSwitch5Closed);
    loadSwitchState("IA-RTDB-6-switch6Closed", setSwitch6Closed);
    loadSwitchState("IA-RTDB-6-switch7Closed", setSwitch7Closed);
    loadSwitchState("IA-RTDB-6-switch8Closed", setSwitch8Closed);
    loadSwitchState("IA-RTDB-6-switch9Closed", setSwitch9Closed);
    loadSwitchState("IA-RTDB-6-switch10Closed", setSwitch10Closed);
    loadSwitchState("IA-RTDB-6-switch11Closed", setSwitch11Closed);
    loadSwitchState("IA-RTDB-6-switch12Closed", setSwitch12Closed);
        ...
        (() => {
          ...
          return createPortal(
            ...
            >
              ...
              >
                {/* Title for the box - match IA-RTDB-6 styling */}
                <div
                  style={{
                    position: "absolute",
                    top: 0,
