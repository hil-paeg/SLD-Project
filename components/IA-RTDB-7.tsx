...
const IARTDB7 = ({
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-7-topSwitchClosed");
    if (saved !== null) {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IA-RTDB-7-isZoomed");
    if (saved !== null) {
  ...
  useEffect(() => {
    ...
    loadSwitchState("IA-RTDB-7-switch1Closed", setSwitch1Closed);
    loadSwitchState("IA-RTDB-7-switch2Closed", setSwitch2Closed);
    loadSwitchState("IA-RTDB-7-switch3Closed", setSwitch3Closed);
    loadSwitchState("IA-RTDB-7-switch4Closed", setSwitch4Closed);
    loadSwitchState("IA-RTDB-7-switch5Closed", setSwitch5Closed);
    loadSwitchState("IA-RTDB-7-switch6Closed", setSwitch6Closed);
    loadSwitchState("IA-RTDB-7-switch7Closed", setSwitch7Closed);
    loadSwitchState("IA-RTDB-7-switch8Closed", setSwitch8Closed);
    loadSwitchState("IA-RTDB-7-switch9Closed", setSwitch9Closed);
    loadSwitchState("IA-RTDB-7-switch10Closed", setSwitch10Closed);
    loadSwitchState("IA-RTDB-7-switch11Closed", setSwitch11Closed);
    loadSwitchState("IA-RTDB-7-switch12Closed", setSwitch12Closed);
  ...
  const isCircuitActive =
    topSwitchClosed &&
    (switch1Closed || switch2Closed || switch3Closed || switch12Closed);
  ...
  const handleBottomSwitchToggle = (switchNumber: number) => {
    ...
    switch (switchNumber) {
      ...
      case 3:
        ...
        break;
      case 12:
        setSwitch12Closed(!switch12Closed);
        break;
    }
  };
        ...
        (() => {
          ...
          return createPortal(
            ...
            >
              ...
              >
                {/* Title for the box - match IA-RTDB-7 styling */}
                <div
                  style={{
                    position: "absolute",
                    top: 0,
        ...
        >
          <div className="relative">
            <svg width="75" height="150" viewBox="0 0 280 350">
              ...
              <foreignObject x="187" y="69" width="30" height="100">
                <Image
                  ...
                  onClick={() => handleBottomSwitchToggle(12)}
                />
              </foreignObject>
            ...
            >
              ...
              <div>F'ce Entry</div>
              <div>Table 1</div>
              <div className="text-red-600">[AM1601-1612]</div>
            </div>
          </div>
        </div>
      )}
