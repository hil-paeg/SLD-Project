...
interface FourIGBTCircuit3Props {
...
const FourIGBTCircuit3 = ({
  ...
  const STORAGE_KEYS = {
    ISOLATOR: "FourIGBT3.isCircuitOn",
    OUTPUTS: "FourIGBT3.outputSwitches",
  };
...
export default FourIGBTCircuit3;
