...
const IBRTDB2 = ({
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IB-RTDB-2-topSwitchClosed");
    if (saved !== null) {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("IB-RTDB-2-isZoomed");
    if (saved !== null) {
  ...
  useEffect(() => {
    ...
    loadSwitchState("IB-RTDB-2-switch1Closed", setSwitch1Closed);
    loadSwitchState("IB-RTDB-2-switch2Closed", setSwitch2Closed);
    loadSwitchState("IB-RTDB-2-switch3Closed", setSwitch3Closed);
    loadSwitchState("IB-RTDB-2-switch4Closed", setSwitch4Closed);
    loadSwitchState("IB-RTDB-2-switch5Closed", setSwitch5Closed);
    loadSwitchState("IB-RTDB-2-switch6Closed", setSwitch6Closed);
    loadSwitchState("IB-RTDB-2-switch7Closed", setSwitch7Closed);
    loadSwitchState("IB-RTDB-2-switch8Closed", setSwitch8Closed);
    loadSwitchState("IB-RTDB-2-switch9Closed", setSwitch9Closed);
    loadSwitchState("IB-RTDB-2-switch10Closed", setSwitch10Closed);
    loadSwitchState("IB-RTDB-2-switch11Closed", setSwitch11Closed);
    loadSwitchState("IB-RTDB-2-switch12Closed", setSwitch12Closed);
        ...
        (() => {
          ...
          return createPortal(
            ...
            >
              ...
              >
                {/* Title for the box - match IB-RTDB-2 styling */}
                <div
                  style={{
                    position: "absolute",
                    top: 0,
